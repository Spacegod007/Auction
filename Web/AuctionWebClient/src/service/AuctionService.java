...
public interface AuctionService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "createCategory", targetNamespace = "http://service/", className = "service.CreateCategory")
    @ResponseWrapper(localName = "createCategoryResponse", targetNamespace = "http://service/", className = "service.CreateCategoryResponse")
    @Action(input = "http://service/AuctionService/createCategoryRequest", output = "http://service/AuctionService/createCategoryResponse")
